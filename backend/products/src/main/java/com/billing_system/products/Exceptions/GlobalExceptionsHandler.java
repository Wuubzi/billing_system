package com.billing_system.products.Exceptions;

import com.billing_system.products.DTO.Response.ExceptionResponseDTO;
...
public class GlobalExceptionsHandler {
    ...
    public ResponseEntity<ExceptionResponseDTO> handleInvalidDataAccessApiUsageException(InvalidDataAccessApiUsageException e, HttpServletRequest request) {
        return new ResponseEntity<>(getExceptionResponseDTO("P-400", e, request), HttpStatus.BAD_REQUEST);
    }
